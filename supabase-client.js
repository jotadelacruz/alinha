 ...
 * pagamentos, contas e prontuários). Operação irreversível —
 * usada apenas pela "Zona de risco" em Configurações > Dados.
 * Não apaga o profile em si (preferências e login continuam).
 */
export async function deleteAllUserData(){
  const tables = ['session_records', 'appointments', 'payments', 'bills', 'clients'];
